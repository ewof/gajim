...
FloatSettings = Literal["app_font_size",]
...
APP_SETTINGS: dict[str, str | int | float | bool | list[Any]] = {
    ...
    "gc_notify_on_reaction_default": True,
    ...
    "notify_on_reaction_default": True,
    ...
    "chat_list_split_groups": False,
    "chat_list_split_position": 0,
...
AllAccountSettings = Literal[
    BoolAccountSettings, IntAccountSettings, StringAccountSettings
]
...
IntGroupChatSettings = Literal["sync_threshold",]


AllGroupChatSettings = Literal[
    BoolGroupChatSettings, IntGroupChatSettings, StringGroupChatSettings
]
...
AllContactSettings = Literal[BoolContactSettings, StringContactSettings]
...
PROXY_EXAMPLES = {
    "Tor": {"type": "socks5", "host": "localhost", "port": 9050},
    "Tor (Browser)": {"type": "socks5", "host": "localhost", "port": 9150},
}


DEFAULT_SOUNDEVENT_SETTINGS = {
    "attention_received": {"enabled": True, "path": "attention.wav"},
    "first_message_received": {"enabled": True, "path": "message1.wav"},
    "contact_connected": {"enabled": False, "path": "connected.wav"},
    "contact_disconnected": {"enabled": False, "path": "disconnected.wav"},
    "message_sent": {"enabled": False, "path": "sent.wav"},
    "muc_message_highlight": {"enabled": True, "path": "gc_message1.wav"},
    "muc_message_received": {"enabled": True, "path": "message2.wav"},
    "incoming-call-sound": {"enabled": True, "path": "call_incoming.wav"},
    "outgoing-call-sound": {"enabled": True, "path": "call_outgoing.wav"},
}
...
ADVANCED_SETTINGS = {
    "app": {
        ...
        "ignore_incoming_attention": _(
            'If enabled, Gajim will ignore incoming attention requests ("wizz").'
        ),
